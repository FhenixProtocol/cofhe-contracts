...
/**
 * Guards `ACPShareRegistry.initialize(initialAdmin)` against a zero `initialAdmin`, mirroring the
 * check `CommitmentRegistry.initialize` already has. A zero admin would deploy a proxy with
 ...
 */
describe("ACPShareRegistry.initialize rejects a zero initialAdmin", function () {
