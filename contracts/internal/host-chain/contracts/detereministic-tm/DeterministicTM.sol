...
import {DeterministicACL, Permission} from "./DeterministicACL.sol";
import {DeterministicPlaintextsStorage} from "./DeterministicPlaintextsStorage.sol";
import {Strings} from "@openzeppelin/contracts/utils/Strings.sol";
import {UUPSUpgradeable} from "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";
import {Ownable2StepUpgradeable} from "@openzeppelin/contracts-upgradeable/access/Ownable2StepUpgradeable.sol";
import {Initializable} from "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import {ECDSA} from "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";
import {ITaskManager, FunctionId, Utils, EncryptedInput} from "./DeterministicICofhe.sol";
...
contract DeterministicTM is ITaskManager, Initializable, UUPSUpgradeable, Ownable2StepUpgradeable {
    ...
    function setACLContract(address _aclAddress) external onlyOwner {
        ...
        acl = DeterministicACL(_aclAddress);
    }
    ...
    function setPlaintextsStorage(address _plaintextsStorageAddress) external onlyOwner {
        ...
        plaintextsStorage = DeterministicPlaintextsStorage(_plaintextsStorageAddress);
    }
