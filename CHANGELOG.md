...
> **Already deployed to testnet-v2 (2026-08-24), but not in any published release:**
> role-based access control, the aggregator allowlist removal, and the four deploy
> fixes that shipped alongside them. The admin change events and the
> `setSecurityZones` fix are **not** deployed anywhere.
...
## v0.2.0 - 2026-08-20 - never deployed to testnet-v2
